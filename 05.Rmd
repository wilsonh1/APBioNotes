...
- Signaling molecule behaves as a **ligand**, a molecule that specifically binds to another molecule
    ...
    - Most signal receptors are plasma membrane proteins with water-soluble ligands <a class="footref">^&dagger;^</a><span class="footbody" style="display: none">**Receptor tyrosine kinases** are discussed in the unabridged textbook and in class, may appear on the AP test</span>
- **G protein-coupled receptor** (GPCR)**:**
    - **G protein:** binds the energy-rich molecule GTP <a class="footref">^&dagger;^</a><span class="footbody" style="display: none">**Receptor tyrosine kinases** are discussed in the unabridged textbook, may appear on the AP test</span>
