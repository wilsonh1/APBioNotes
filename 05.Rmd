...
- Tonicity: the ability of a solution to cause a cell to gain or lose water
    ...
    ```{r osmosis, echo = FALSE, out.height = "250px", fig.align = "center"}
...
<div class="flex-img">
 ```{r cotransport, echo = FALSE, out.height = "200px", fig.align = "center"}
...
## **5.5** Bulk transport
- Large molecules cross the membrane in bulk by mechanisms that involve packaging in vesicles
- Requires energy
...
#### Reception: ^[**Receptor tyrosine kinases** are discussed in the unabridged textbook]
- Signaling molecule behaves as a **ligand**, a molecule that specifically binds to another molecule
    ...
    - Most signal receptors are plasma membrane proteins with water-soluble ligands
- **G protein-coupled receptor** (GPCR)**:**

    ```{r gpcr, echo = FALSE, out.height = "250px", fig.align = "center"}
...
- **Ligand-gated ion channel:**
    ...
    - Membrane receptor with a region that acts as a gate when a certain shape is assumed
...
<div class="flex-img">
```{r steroidhormone, echo = FALSE, out.height = "350px", fig.align = "center"}
